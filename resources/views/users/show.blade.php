                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$we->created_at}}</td>
                                    <td>{{$we->updated_at}}</td>
                                    <td><a href="{{route('edite_user',$we->id)}}"><button type="button" class="btn btn-success">edite</button></a></td>


                                    <td><a href="{{route('ds_user',$we->id)}}"> <button type="button" class="btn btn-danger">delete</button></a></td>
                                </tr>
