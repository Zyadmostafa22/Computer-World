            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="bg-secondary rounded h-100 p-4" >
                        ...
                        <img class="rounded-circle" src="{{asset('img/'.$products->image)}}"  style="width: 40px; height: 40px;" alt="">
                        <form method="POST" action="{{route('update_product',$products->id)}}" enctype="multipart/form-data">@csrf

                            <div class="mb-3">

                                <label for="exampleInputEmail1" class="form-label">product name</label>
                                <input type="text" class="form-control" value="{{$products->name}}" name="name" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">

                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">discription</label>
                                <input type="text" value="{{$products->dis}}"  name="dis" class="form-control" id="exampleInputPassword1">
                            </div>
                            <select class="form-select form-select-sm mb-3" name="allaw" aria-label=".form-select-sm example">
                                <option value="1" >نشر</option>
                                <option value="0" >عدم النشر</option>
                            </select>
                            <select class="form-select form-select-sm mb-3" name="type" aria-label=".form-select-sm example"  >
                                {{--
1       >اجهزة الكمبيوتر<
...
8       >حقائب لابتوبات ماركة<
                                    ...
                                    <option value="1" >اجهزة الكمبيوتر</option>
                                <option value="2">مستلزمات الكمبيوتر</option>
                                <option value="6">اجهزة عرض</option>
                                <option value="3">طابعات</option>
                                <option value="4">منظومات كايمرات مراقبة</option>
                                <option value="5" >اجهزة شبكات</option>
                                <option value="7" >اجهزة ألعاب</option>
                                <option value="8" >حقائب لابتوبات ماركة</option>
