                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle"
                            src="img/png-clipart-user-profile-computer-icons-login-user-avatars-monochrome-black-thumbnail.png"
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <i class="bi bi-person-circle" class="rounded-circle me-lg-2"
                                ...
                                @foreach ($products as $we)
                                    @if ($we->type == 8)
                                        <tr>
                                            ...
                                            <td>{{ $we->created_at }}</td>
                                            <td>{{ $we->updated_at }}</td>
                                            <td><a href="{{ route('edit_product', $we->id) }}"><button type="button"
                                                        class="btn btn-success">edite</button></a></td>


                                            <td><a href="{{ route('delete_product', $we->id) }}"> <button
